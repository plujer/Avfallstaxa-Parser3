...
echo.
echo [2/7] Parser semantic/explain/architecture/missing-debug...
python run.py --word "C:\PyProjects\data\Taxestruktur.docx" --semantic --explain --architecture --missing-debug > output\parser_console.txt 2>&1
