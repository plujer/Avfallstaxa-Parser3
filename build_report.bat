...
echo.
echo [1/7] Master profile...
python run.py --profile-master --master "C:\PyProjects\data\Master.xlsx" > output\master_console.txt 2>&1

echo.
echo [2/7] Parser semantic/explain/architecture/acceptance...
python run.py --word "C:\PyProjects\data\Taxestruktur.docx" --semantic --explain --architecture --acceptance > output\parser_console.txt 2>&1
