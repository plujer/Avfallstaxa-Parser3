...
echo.
echo [5/24] Scannar och normaliserar standardtaxekatalog...
...
echo.
echo [6/24] Extraherar taxekunskap...
...
echo.
echo [7/24] Bygger Knowledge Index...
...
echo.
echo [8/24] Bygger semantiska taxaprofiler...
...
echo.
echo [9/24] Rankar semantiska kandidater...
...
echo.
echo [10/24] Profilerar Arbets-Excel...
...
echo.
echo [11/24] Läser EDP-regelverk...
...
echo.
echo [12/24] Bygger Master Rule Repository...
...
echo.
echo [13/24] Skapar Arbets-Excel snapshot...
...
echo.
echo [14/24] Bygger Taxepunkter row plan...
...
echo.
echo [15/24] Kör Matching Engine preview...
...
echo.
echo [16/24] Skapar standardtaxeförslag...
...
echo.
echo [17/24] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [18/24] Skriver Tax Knowledge till Arbets-Excel...
...
echo.
echo [19/24] Skriver standardtaxeförslag till Arbets-Excel...
...
echo.
echo [20/24] Kör samlad beslutsmotor...
...
echo.
echo [21/24] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [22/24] Kör isolerad Sorsele projektkörning...
...
echo.
echo [23/24] Skapar standardiserad rapportzip...
