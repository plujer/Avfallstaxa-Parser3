...
echo.
echo [5/16] Skapar Arbets-Excel snapshot...
...
echo.
echo [6/16] Bygger Taxepunkter row plan...
...
echo.
echo [7/16] Kör Matching Engine preview...
...
echo.
echo [8/16] Skapar standardtaxeförslag...
...
echo.
echo [9/16] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [10/16] Skriver standardtaxeförslag till Arbets-Excel...
...
echo.
echo [11/16] Kör samlad beslutsmotor...
...
echo.
echo [12/16] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [13/16] Kör isolerad Sorsele projektkörning...
...
echo.
echo [14/16] Kör isolerade projekt för alla kommuner...
...
echo.
echo [15/16] Skapar standardiserad rapportzip...
