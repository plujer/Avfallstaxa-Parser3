...
echo.
echo [5/15] Skapar Arbets-Excel snapshot...
...
echo.
echo [6/15] Bygger Taxepunkter row plan...
...
echo.
echo [7/15] Kör Matching Engine preview...
...
echo.
echo [8/15] Skapar standardtaxeförslag...
...
echo.
echo [9/15] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [10/15] Skriver standardtaxeförslag till Arbets-Excel...
...
echo.
echo [11/15] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [12/15] Kör isolerad Sorsele projektkörning...
...
echo.
echo [13/15] Kör isolerade projekt för alla kommuner...
...
echo.
echo [14/15] Skapar standardiserad rapportzip...
