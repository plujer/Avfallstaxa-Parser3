...
echo.
echo [5/19] Bygger Knowledge Index...
...
echo.
echo [6/19] Profilerar Arbets-Excel...
...
echo.
echo [8/19] Skapar Arbets-Excel snapshot...
...
echo.
echo [9/19] Bygger Taxepunkter row plan...
...
echo.
echo [10/19] Kör Matching Engine preview...
...
echo.
echo [11/19] Skapar standardtaxeförslag...
...
echo.
echo [12/19] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [13/19] Skriver Tax Knowledge till Arbets-Excel...
...
echo.
echo [14/19] Skriver standardtaxeförslag till Arbets-Excel...
...
echo.
echo [15/19] Kör samlad beslutsmotor...
...
echo.
echo [16/19] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [17/19] Kör isolerad Sorsele projektkörning...
...
echo.
echo [18/19] Skapar standardiserad rapportzip...
