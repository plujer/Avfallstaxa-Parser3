...
echo.
echo [5/18] Profilerar Arbets-Excel...
...
echo.
echo [7/18] Skapar Arbets-Excel snapshot...
...
echo.
echo [8/18] Bygger Taxepunkter row plan...
...
echo.
echo [9/18] Kör Matching Engine preview...
...
echo.
echo [10/18] Skapar standardtaxeförslag...
...
echo.
echo [11/18] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [12/18] Skriver Tax Knowledge till Arbets-Excel...
...
echo.
echo [13/18] Skriver standardtaxeförslag till Arbets-Excel...
...
echo.
echo [14/18] Kör samlad beslutsmotor...
...
echo.
echo [15/18] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [16/18] Kör isolerad Sorsele projektkörning...
...
echo.
echo [17/18] Skapar standardiserad rapportzip...
