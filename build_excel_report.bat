...
echo.
echo [5/27] Scannar masterarbetsbokens schema...
...
echo.
echo [6/27] Scannar och normaliserar standardtaxekatalog...
...
echo.
echo [8/27] Extraherar taxekunskap...
...
echo.
echo [9/27] Bygger Knowledge Index...
...
echo.
echo [10/27] Bygger semantiska taxaprofiler...
...
echo.
echo [11/27] Rankar semantiska kandidater...
...
echo.
echo [12/27] Profilerar Arbets-Excel...
...
echo.
echo [13/27] Läser EDP-regelverk...
...
echo.
echo [14/27] Bygger Master Rule Repository...
...
echo.
echo [15/27] Skapar Arbets-Excel snapshot...
...
echo.
echo [16/27] Bygger Taxepunkter row plan...
...
echo.
echo [17/27] Kör Matching Engine preview...
...
echo.
echo [18/27] Skapar standardtaxeförslag...
...
echo.
echo [19/27] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [20/27] Skriver Tax Knowledge till Arbets-Excel...
...
echo.
echo [21/27] Skriver standardtaxeförslag till Arbets-Excel...
...
echo.
echo [22/27] Kör gammal beslutsmotor för jämförelse...
...
echo.
echo [23/27] Kör semantisk beslutsmotor...
python excel_builder_decide_semantic.py --parser-result "output\reports\parser3_result.json" --reference-workbook "data\ArbetsExcel_Reference.xlsx" --standard-tax "data\edp_standard\EDP_Future_Standard_Taxor_Renhallning.xlsx" --workbook "output\excel\ArbetsExcel_byggd_fran_parser.xlsx" > output\excel\tax_decision_semantic_console.txt 2>&1

echo.
echo [24/27] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [25/27] Kör isolerad Sorsele projektkörning...
...
echo.
echo [26/27] Skapar standardiserad rapportzip...
