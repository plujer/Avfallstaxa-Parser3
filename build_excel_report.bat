...
echo.
echo [5/13] Skapar Arbets-Excel snapshot...
...
echo.
echo [6/13] Bygger Taxepunkter row plan...
...
echo.
echo [7/13] Kör Matching Engine preview...
...
echo.
echo [8/13] Skapar standardtaxeförslag...
...
echo.
echo [9/13] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [10/13] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [11/13] Kör isolerad Sorsele projektkörning...
...
echo.
echo [12/13] Kör isolerade projekt för alla kommuner...
...
echo.
echo [13/13] Skapar standardiserad rapportzip...
