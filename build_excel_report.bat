...
echo.
echo [10/35] Bygger Tax Family Intelligence...
...
echo.
echo [11/35] Bygger Variant Intelligence...
...
echo.
echo [12/35] Bygger Semantic Attribute Intelligence...
...
echo.
echo [13/35] Bygger Composite Matching Engine...
...
echo.
echo [14/35] Bygger Explainable Decision Engine...
...
echo.
echo [15/35] Extraherar taxekunskap...
...
echo.
echo [16/35] Bygger Knowledge Index...
...
echo.
echo [17/35] Bygger semantiska taxaprofiler...
...
echo.
echo [18/35] Rankar semantiska kandidater...
...
echo.
echo [19/35] Profilerar Arbets-Excel...
...
echo.
echo [20/35] Läser EDP-regelverk...
...
echo.
echo [21/35] Bygger Master Rule Repository...
...
echo.
echo [22/35] Skapar Arbets-Excel snapshot...
...
echo.
echo [23/35] Bygger Taxepunkter row plan...
...
echo.
echo [24/35] Kör Matching Engine preview...
...
echo.
echo [25/35] Skapar standardtaxeförslag...
...
echo.
echo [26/35] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [27/35] Skriver Tax Knowledge till Arbets-Excel...
...
echo.
echo [28/35] Skriver standardtaxeförslag till Arbets-Excel...
...
echo.
echo [29/35] Kör gammal beslutsmotor för jämförelse...
...
echo.
echo [30/35] Kör semantisk beslutsmotor...
python excel_builder_decide_semantic.py --parser-result "output\reports\parser3_result.json" --reference-workbook "data\master_templates\ArbetsExcel_Template_v0.9.4_draft.xlsx" --standard-tax "data\edp_standard\EDP_Future_Standard_Taxor_Renhallning.xlsx" --workbook "output\excel\ArbetsExcel_byggd_fran_parser.xlsx" > output\excel\tax_decision_semantic_console.txt 2>&1


echo.
echo [31/35] Skriver beslutsspårning till Arbets-Excel...
python excel_builder_workbook_generation.py --workbook "output\excel\ArbetsExcel_byggd_fran_parser.xlsx" --decision-traces "output\excel\decision_traces.csv" > output\excel\workbook_generation_console.txt 2>&1

echo.
echo [32/35] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [33/35] Kör isolerad Sorsele projektkörning...
...
echo.
echo [34/35] Skapar standardiserad rapportzip...
