...
echo.
echo [5/25] Scannar och normaliserar standardtaxekatalog...
...
echo.
echo [6/25] Extraherar taxekunskap...
...
echo.
echo [7/25] Bygger Knowledge Index...
...
echo.
echo [8/25] Bygger semantiska taxaprofiler...
...
echo.
echo [9/25] Rankar semantiska kandidater...
...
echo.
echo [10/25] Profilerar Arbets-Excel...
...
echo.
echo [11/25] Läser EDP-regelverk...
...
echo.
echo [12/25] Bygger Master Rule Repository...
...
echo.
echo [13/25] Skapar Arbets-Excel snapshot...
...
echo.
echo [14/25] Bygger Taxepunkter row plan...
...
echo.
echo [15/25] Kör Matching Engine preview...
...
echo.
echo [16/25] Skapar standardtaxeförslag...
...
echo.
echo [17/25] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [18/25] Skriver Tax Knowledge till Arbets-Excel...
...
echo.
echo [19/25] Skriver standardtaxeförslag till Arbets-Excel...
...
echo.
echo [20/25] Kör gammal beslutsmotor för jämförelse...
...
echo.
echo [21/25] Kör semantisk beslutsmotor...
python excel_builder_decide_semantic.py --parser-result "output\reports\parser3_result.json" --reference-workbook "data\ArbetsExcel_Reference.xlsx" --standard-tax "data\edp_standard\EDP_Future_Standard_Taxor_Renhallning.xlsx" --workbook "output\excel\ArbetsExcel_byggd_fran_parser.xlsx" > output\excel\tax_decision_semantic_console.txt 2>&1

echo.
echo [22/25] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [23/25] Kör isolerad Sorsele projektkörning...
...
echo.
echo [24/25] Skapar standardiserad rapportzip...
