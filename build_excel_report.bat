...
echo.
echo [5/23] Scannar och normaliserar standardtaxekatalog...
...
echo.
echo [6/23] Extraherar taxekunskap...
...
echo.
echo [7/23] Bygger Knowledge Index...
...
echo.
echo [8/23] Bygger semantiska taxaprofiler...
...
echo.
echo [9/23] Profilerar Arbets-Excel...
...
echo.
echo [10/23] Läser EDP-regelverk...
...
echo.
echo [11/23] Bygger Master Rule Repository...
...
echo.
echo [12/23] Skapar Arbets-Excel snapshot...
...
echo.
echo [13/23] Bygger Taxepunkter row plan...
...
echo.
echo [14/23] Kör Matching Engine preview...
...
echo.
echo [15/23] Skapar standardtaxeförslag...
...
echo.
echo [16/23] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [17/23] Skriver Tax Knowledge till Arbets-Excel...
...
echo.
echo [18/23] Skriver standardtaxeförslag till Arbets-Excel...
...
echo.
echo [19/23] Kör samlad beslutsmotor...
...
echo.
echo [20/23] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [21/23] Kör isolerad Sorsele projektkörning...
...
echo.
echo [22/23] Skapar standardiserad rapportzip...
