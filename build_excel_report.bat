...
echo.
echo [5/26] Scannar masterarbetsbokens schema...
...
echo.
echo [6/26] Scannar och normaliserar standardtaxekatalog...
...
echo.
echo [7/26] Extraherar taxekunskap...
...
echo.
echo [8/26] Bygger Knowledge Index...
...
echo.
echo [9/26] Bygger semantiska taxaprofiler...
...
echo.
echo [10/26] Rankar semantiska kandidater...
...
echo.
echo [11/26] Profilerar Arbets-Excel...
...
echo.
echo [12/26] Läser EDP-regelverk...
...
echo.
echo [13/26] Bygger Master Rule Repository...
...
echo.
echo [14/26] Skapar Arbets-Excel snapshot...
...
echo.
echo [15/26] Bygger Taxepunkter row plan...
...
echo.
echo [16/26] Kör Matching Engine preview...
...
echo.
echo [17/26] Skapar standardtaxeförslag...
...
echo.
echo [18/26] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [19/26] Skriver Tax Knowledge till Arbets-Excel...
...
echo.
echo [20/26] Skriver standardtaxeförslag till Arbets-Excel...
...
echo.
echo [21/26] Kör gammal beslutsmotor för jämförelse...
...
echo.
echo [22/26] Kör semantisk beslutsmotor...
python excel_builder_decide_semantic.py --parser-result "output\reports\parser3_result.json" --reference-workbook "data\ArbetsExcel_Reference.xlsx" --standard-tax "data\edp_standard\EDP_Future_Standard_Taxor_Renhallning.xlsx" --workbook "output\excel\ArbetsExcel_byggd_fran_parser.xlsx" > output\excel\tax_decision_semantic_console.txt 2>&1

echo.
echo [23/26] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [24/26] Kör isolerad Sorsele projektkörning...
...
echo.
echo [25/26] Skapar standardiserad rapportzip...
