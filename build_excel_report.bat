...
echo.
echo [5/12] Skapar Arbets-Excel snapshot...
...
echo.
echo [6/12] Bygger Taxepunkter row plan...
...
echo.
echo [7/12] Kör Matching Engine preview...
...
echo.
echo [8/12] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [9/12] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [10/12] Kör isolerad Sorsele projektkörning...
...
echo.
echo [11/12] Kör isolerade projekt för alla kommuner...
...
echo.
echo [12/12] Skapar standardiserad rapportzip...
