...
echo.
echo [10/33] Bygger Tax Family Intelligence...
...
echo.
echo [11/33] Bygger Variant Intelligence...
...
echo.
echo [12/33] Bygger Semantic Attribute Intelligence...
...
echo.
echo [13/33] Bygger Composite Matching Engine...
...
echo.
echo [14/33] Extraherar taxekunskap...
...
echo.
echo [15/33] Bygger Knowledge Index...
...
echo.
echo [16/33] Bygger semantiska taxaprofiler...
...
echo.
echo [17/33] Rankar semantiska kandidater...
...
echo.
echo [18/33] Profilerar Arbets-Excel...
...
echo.
echo [19/33] Läser EDP-regelverk...
...
echo.
echo [20/33] Bygger Master Rule Repository...
...
echo.
echo [21/33] Skapar Arbets-Excel snapshot...
...
echo.
echo [22/33] Bygger Taxepunkter row plan...
...
echo.
echo [23/33] Kör Matching Engine preview...
...
echo.
echo [24/33] Skapar standardtaxeförslag...
...
echo.
echo [25/33] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [26/33] Skriver Tax Knowledge till Arbets-Excel...
...
echo.
echo [27/33] Skriver standardtaxeförslag till Arbets-Excel...
...
echo.
echo [28/33] Kör gammal beslutsmotor för jämförelse...
...
echo.
echo [29/33] Kör semantisk beslutsmotor...
python excel_builder_decide_semantic.py --parser-result "output\reports\parser3_result.json" --reference-workbook "data\master_templates\ArbetsExcel_Template_v0.9.4_draft.xlsx" --standard-tax "data\edp_standard\EDP_Future_Standard_Taxor_Renhallning.xlsx" --workbook "output\excel\ArbetsExcel_byggd_fran_parser.xlsx" > output\excel\tax_decision_semantic_console.txt 2>&1

echo.
echo [30/33] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [31/33] Kör isolerad Sorsele projektkörning...
...
echo.
echo [32/33] Skapar standardiserad rapportzip...
