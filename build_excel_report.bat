...
echo.
echo [5/21] Extraherar taxekunskap...
...
echo.
echo [6/21] Bygger Knowledge Index...
...
echo.
echo [7/21] Profilerar Arbets-Excel...
...
echo.
echo [9/21] Bygger Master Rule Repository...
...
echo.
echo [10/21] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [11/21] Skriver Tax Knowledge till Arbets-Excel...
...
echo.
echo [12/21] Skapar standardtaxeförslag...
...
echo.
echo [13/21] Skriver standardtaxeförslag till Arbets-Excel...
...
echo.
echo [14/21] Kör samlad beslutsmotor...
...
echo.
echo [15/21] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [16/21] Kör isolerad Sorsele projektkörning...
...
echo.
echo [17/21] Uppdaterar Sorsele med Tax Knowledge...
...
echo.
echo [18/21] Uppdaterar Sorsele med standardförslag...
...
echo.
echo [19/21] Uppdaterar Sorsele med EDP-avvikelser...
...
echo.
echo [20/21] Skapar standardiserad rapportzip...
