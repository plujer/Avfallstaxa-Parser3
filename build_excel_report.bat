...
echo.
echo [5/20] Bygger Knowledge Index...
...
echo.
echo [6/20] Profilerar Arbets-Excel...
...
echo.
echo [8/20] Bygger Master Rule Repository...
...
echo.
echo [9/20] Skapar Arbets-Excel snapshot...
...
echo.
echo [10/20] Bygger Taxepunkter row plan...
...
echo.
echo [11/20] Kör Matching Engine preview...
...
echo.
echo [12/20] Skapar standardtaxeförslag...
...
echo.
echo [13/20] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [14/20] Skriver Tax Knowledge till Arbets-Excel...
...
echo.
echo [15/20] Skriver standardtaxeförslag till Arbets-Excel...
...
echo.
echo [16/20] Kör samlad beslutsmotor...
...
echo.
echo [17/20] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [18/20] Kör isolerad Sorsele projektkörning...
...
echo.
echo [19/20] Skapar standardiserad rapportzip...
