...
echo.
echo [11/32] Bygger Variant Intelligence...
...
echo.
echo [12/32] Bygger Semantic Attribute Intelligence...
...
echo.
echo [13/32] Extraherar taxekunskap...
...
echo.
echo [14/32] Bygger Knowledge Index...
...
echo.
echo [15/32] Bygger semantiska taxaprofiler...
...
echo.
echo [16/32] Rankar semantiska kandidater...
...
echo.
echo [17/32] Profilerar Arbets-Excel...
...
echo.
echo [18/32] Läser EDP-regelverk...
...
echo.
echo [19/32] Bygger Master Rule Repository...
...
echo.
echo [20/32] Skapar Arbets-Excel snapshot...
...
echo.
echo [21/32] Bygger Taxepunkter row plan...
...
echo.
echo [22/32] Kör Matching Engine preview...
...
echo.
echo [23/32] Skapar standardtaxeförslag...
...
echo.
echo [24/32] Bygger Arbets-Excel från parseroutput...
...
echo.
echo [25/32] Skriver Tax Knowledge till Arbets-Excel...
...
echo.
echo [26/32] Skriver standardtaxeförslag till Arbets-Excel...
...
echo.
echo [27/32] Kör gammal beslutsmotor för jämförelse...
...
echo.
echo [28/32] Kör semantisk beslutsmotor...
python excel_builder_decide_semantic.py --parser-result "output\reports\parser3_result.json" --reference-workbook "data\master_templates\ArbetsExcel_Template_v0.9.4_draft.xlsx" --standard-tax "data\edp_standard\EDP_Future_Standard_Taxor_Renhallning.xlsx" --workbook "output\excel\ArbetsExcel_byggd_fran_parser.xlsx" > output\excel\tax_decision_semantic_console.txt 2>&1

echo.
echo [29/32] Validerar att alla Word-taxor finns i Taxepunkter...
...
echo.
echo [30/32] Kör isolerad Sorsele projektkörning...
...
echo.
echo [31/32] Skapar standardiserad rapportzip...
